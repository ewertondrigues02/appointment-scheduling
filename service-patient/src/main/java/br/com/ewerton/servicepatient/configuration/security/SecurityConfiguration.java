    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/patients/auth/register").permitAll()
                      //  .requestMatchers(HttpMethod.POST, "/patients").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/patients/{id}").permitAll()
                        .requestMatchers(HttpMethod.POST, "/patients/schedules").permitAll()
